    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            spotifyApi.put(api, payload)['catch'](function (err) {
              Util_1.logIt(
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            beApi.get(api)['catch'](function (err) {
              Util_1.logIt(
                'error fetching data for ' + api + ', message: ' + err.message,
              );
              return err;
            }),
          ];
