...
var jiraClient = axios_1["default"].create({
...
var JiraClient = /** @class */ (function () {
    ...
    JiraClient.getInstance = function () {
        if (!JiraClient.instance) {
            JiraClient.instance = new JiraClient();
        }
        return JiraClient.instance;
    };
    JiraClient.prototype.apiGet = function (api, accessToken) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, jiraClient.get(api)["catch"](function (err) {
    ...
    JiraClient.prototype.fetchIssues = function () {
        return __awaiter(this, void 0, void 0, function () {
            var accessToken;
            return __generator(this, function (_a) {
                accessToken = Util_1.getItem("atlassian_access_token");
                return [2 /*return*/, this.apiGet("/rest/api/3/issuetype", accessToken)];
            });
        });
    };
    return JiraClient;
