...
var SummaryManager = /** @class */ (function () {
  ...
  SummaryManager.prototype.init = function () {
    ...
    this._dayCheckTimer = setInterval(function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              HttpClient_1.softwareGet('/sessions/summary?refresh=true', jwt),
            ];
          case 1:
            result = _a.sent();
            if (HttpClient_1.isResponseOk(result) && result.data) {
              ...
              TimeSummaryData_1.updateSessionFromSummaryApi(
                summary_1.currentDayMinutes,
              );
