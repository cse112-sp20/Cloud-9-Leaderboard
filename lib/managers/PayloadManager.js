...
function validateAndUpdateCumulativeData(payload, sessionMinutes) {
    return __awaiter(this, void 0, void 0, function () {
        var td, lastPayload, _a, cumulative_editor_seconds, cumulative_session_seconds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, TimeSummaryData_1.incrementSessionAndFileSecondsAndFetch(payload.project, sessionMinutes)];
                case 1:
                    td = _b.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, SummaryManager_1.SummaryManager.getInstance().newDayChecker()];
                case 3:
                    _b.sent();
                    _b.label = 4;
                case 4:
...
function processPayload(payload, sendNow) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var nowTimes, _a, sessionMinutes, elapsedSeconds, keys, directory, projName, resourceInfo, i, fileName, workspaceFolder, p, repoContributorInfo, repoFileCount, i, key, fileInfo, repoFileContributorCount;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    nowTimes = Util_1.getNowTimes();
                    _a = SessionSummaryData_1.getTimeBetweenLastPayload(), sessionMinutes = _a.sessionMinutes, elapsedSeconds = _a.elapsedSeconds;
                ...
                case 4:
                    ...
                    return [4 /*yield*/, validateAndUpdateCumulativeData(payload, sessionMinutes)];
                case 5:
                    // validate the cumulative data
                    _b.sent();
                    ...
                    return [4 /*yield*/, KpmRepoManager_1.getRepoContributorInfo(directory, true)];
                case 6:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateAggregateInfo(fileChangeInfoMap, payload, sessionMinutes)];
                case 1:
                    _a.sent();
                    ...
                    fs.appendFileSync(Util_1.getSoftwareDataStoreFile(), JSON.stringify(payload) + os.EOL, function (err) {
                        if (err)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, SessionSummaryData_1.incrementSessionSummaryData(aggregate, sessionMinutes)];
                case 1:
                    // this will increment and store it offline
                    _a.sent();
                    return [2 /*return*/];
