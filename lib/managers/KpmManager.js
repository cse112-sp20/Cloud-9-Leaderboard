...
var KpmManager = /** @class */ (function () {
  function KpmManager() {
    ...
    this._disposable = vscode_1.Disposable.from.apply(
      vscode_1.Disposable,
      subscriptions,
    );
  }
        ...
        if (this.hasKeystrokeData()) {
          ...
          _loop_1 = function (i) {
            ...
            if (hasData) {
              ...
              setTimeout(function () {
                return keystrokeStats.postData();
              }, 0);
            }
          };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.initializeKeystrokesCount(staticInfo.filename, rootPath),
            ];
          case 2:
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.initializeKeystrokesCount(filename, rootPath),
            ];
          case 2:
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            // start the process
            Util_1.showInformationMessage(
              'Selected the following text: ' + text,
            );
            return [
              4 /*yield*/,
              JiraClient_1.JiraClient.getInstance().fetchIssues(),
            ];
          case 1:
            issues = _a.sent();
            return [3 /*break*/, 3];
  ...
  KpmManager.prototype.isTrueEventFile = function (event, filename) {
    ...
    var isLiveshareTmpFile = filename.match(
      /.*\.code-workspace.*vsliveshare.*tmp-.*/,
    );
    var isInternalFile = filename.match(
  ...
  KpmManager.prototype.buildBootstrapKpmPayload = function () {
    ...
    setTimeout(function () {
      return keystrokeStats.postData(true /*sendNow*/);
    }, 0);
  };
  KpmManager.prototype.endPreviousModifiedFiles = function (
    filename,
    rootPath,
  ) {
  ...
  KpmManager.prototype.initializeKeystrokesCount = function (
    filename,
    rootPath,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.createKeystrokeStats(filename, rootPath, nowTimes),
            ];
          case 1:
          ...
          case 2:
            ...
            if (!hasFile) {
              ...
              parseInt(keystrokeStats.source[filename].end, 10) !== 0
            ) {
  ...
  KpmManager.prototype.createKeystrokeStats = function (
    filename,
    rootPath,
    nowTimes,
  ) {
