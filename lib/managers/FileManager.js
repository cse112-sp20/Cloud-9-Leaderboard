...
function sendOfflineData(isNewDay) {
    if (isNewDay === void 0) { isNewDay = false; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            try {
                ...
                if (fs.existsSync(dataFile)) {
                    ...
                    if (currentPayloads && currentPayloads.length) {
                        ...
                        currentPayloads.sort(function (a, b) { return b.start - a.start; });
                        // get the 1st element
...
function sendBatchPayload(api, batch) {
    ...
    // console.log(batch);
    return HttpClient_1.softwarePost(api, batch, Util_1.getItem("jwt"))["catch"](function (e) {
