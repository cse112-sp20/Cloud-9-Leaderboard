...
function createCommands(kpmController) {
    ...
    // MENU TREE: REVEAL
    cmds.push(vscode_1.commands.registerCommand('codetime.displayTree', function () {
        codetimeMenuTreeProvider.revealTree();
    }));
    // MENU TREE: REFRESH
    cmds.push(vscode_1.commands.registerCommand('codetime.refreshCodetimeMenuTree', function () {
    ...
    // TEAM TREE: REFRESH
    cmds.push(vscode_1.commands.registerCommand('codetime.refreshCodetimeTeamTree', function () {
        codetimeTeamTreeProvider.refresh();
    }));
    cmds.push(vscode_1.commands.registerCommand('codetime.refreshTreeViews', function () {
        codetimeMenuTreeProvider.refresh();
        kpmTreeProvider.refresh();
        codetimeTeamTreeProvider.refresh();
    }));
    // TEAM TREE: INVITE MEMBER
    cmds.push(vscode_1.commands.registerCommand('codetime.inviteTeamMember', function (item) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, vscode_1.window.showInformationMessage.apply(vscode_1.window, __spreadArrays([msg,
                            { modal: true }], ['YES']))];
                case 1:
                    selection = _a.sent();
    ...
    // SEND OFFLINE DATA
    cmds.push(vscode_1.commands.registerCommand('codetime.sendOfflineData', function () {
        FileManager_1.sendOfflineData();
    }));
    // SHOW ASCII DASHBOARD
    cmds.push(vscode_1.commands.registerCommand('codetime.softwareKpmDashboard', function () {
        DataController_1.handleKpmClickedEvent();
    }));
    // OPEN SPECIFIED FILE IN EDITOR
    cmds.push(vscode_1.commands.registerCommand('codetime.openFileInEditor', function (file) {
        Util_1.openFileInEditor(file);
    }));
    // REFRESH MENU
    cmds.push(vscode_1.commands.registerCommand('codetime.toggleStatusBar', function () {
    ...
    // LAUNCH EMAIL LOGIN
    cmds.push(vscode_1.commands.registerCommand('codetime.codeTimeLogin', function () {
        Util_1.launchLogin('software');
    }));
    // LAUNCH GOOGLE LOGIN
    cmds.push(vscode_1.commands.registerCommand('codetime.googleLogin', function () {
        Util_1.launchLogin('google');
    }));
    // LAUNCH GITHUB LOGIN
    cmds.push(vscode_1.commands.registerCommand('codetime.githubLogin', function () {
        Util_1.launchLogin('github');
    }));
    // REFRESH DAILY METRICS
    cmds.push(vscode_1.commands.registerCommand('codetime.refreshKpmTree', function (keystrokeStats) {
        if (keystrokeStats) {
    ...
    // DISPLAY README MD
    cmds.push(vscode_1.commands.registerCommand('codetime.displayReadme', function () {
        Util_1.displayReadmeIfNotExists(true /*override*/);
    }));
    // DISPLAY CODE TIME METRICS REPORT
    cmds.push(vscode_1.commands.registerCommand('codetime.codeTimeMetrics', function () {
        MenuManager_1.displayCodeTimeMetricsDashboard();
    }));
    /*
     * CLOUD 9 LEADERBOARD COMMAND
     */
    cmds.push(vscode_1.commands.registerCommand('cloud9.leaderboard', function () {
        Leaderboard_1.displayLeaderboard();
    }));
    // Cloud9: command used to create a new team
    cmds.push(vscode_1.commands.registerCommand('cloud9.createTeam', function () {
        console.log('Cloud9: CREATE A NEW TEAM');
    }));
    // Cloud9: command used to join a new team
    cmds.push(vscode_1.commands.registerCommand('cloud9.joinTeam', function () {
        console.log('Cloud9: JOIN A TEAM');
    }));
    // Cloud9: command used to clear the cached id (for debugging and testing only)
    cmds.push(vscode_1.commands.registerCommand('cloud9.debugClearUserId', function () {
        console.log('Cloud9: CLEAR CACHED ID');
        Authentication_1.clearCachedUserId();
    }));
    // DISPLAY PROJECT METRICS REPORT
    cmds.push(vscode_1.commands.registerCommand('codetime.generateProjectSummary', function () {
    ...
    cmds.push(vscode_1.commands.registerCommand('codetime.generateContributorSummary', function (identifier) {
        ReportManager_1.displayProjectContributorCommitsDashboard(identifier);
    }));
    // LAUNCH COMMIT URL
    cmds.push(vscode_1.commands.registerCommand('codetime.launchCommitUrl', function (commitLink) {
        Util_1.launchWebUrl(commitLink);
    }));
    // DISPLAY PALETTE MENU
    cmds.push(vscode_1.commands.registerCommand('codetime.softwarePaletteMenu', function () {
        MenuManager_1.showMenuOptions();
    }));
    cmds.push(vscode_1.commands.registerCommand('codetime.viewSoftwareTop40', function () {
        Util_1.launchWebUrl('https://api.software.com/music/top40');
    }));
    cmds.push(vscode_1.commands.registerCommand('codetime.codeTimeStatusToggle', function () {
        Util_1.handleCodeTimeStatusToggle();
    }));
    cmds.push(vscode_1.commands.registerCommand('codetime.sendFeedback', function () {
        Util_1.launchWebUrl('mailto:cody@software.com');
    }));
    cmds.push(vscode_1.workspace.onDidChangeConfiguration(function (e) { return DataController_1.updatePreferences(); }));
