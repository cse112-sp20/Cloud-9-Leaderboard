...
function getVersion() {
    var extension = vscode_1.extensions.getExtension(Constants_1.CODE_TIME_EXT_ID);
...
function codeTimeExtInstalled() {
    var codeTimeExt = vscode_1.extensions.getExtension(Constants_1.CODE_TIME_EXT_ID);
...
function getHostname() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getCommandResultLine("hostname")];
                case 1:
                    hostname = _a.sent();
...
function getCommandResultLine(cmd, projectDir) {
    if (projectDir === void 0) { projectDir = null; }
    return __awaiter(this, void 0, void 0, function () {
        var resultList, resultLine, i, line;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getCommandResultList(cmd, projectDir)];
                case 1:
                    resultList = _a.sent();
                    resultLine = "";
...
function getCommandResultList(cmd, projectDir) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, wrapExecPromise("" + cmd, projectDir)];
                case 1:
                    result = _a.sent();
                    if (!result) {
                        return [2 /*return*/, []];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    username = _a.sent();
                    _a.label = 2;
                case 2: return [2 /*return*/, username];
            }
        });
    });
}
...
function openFileInEditor(file) {
    vscode_1.workspace.openTextDocument(file).then(function (doc) {
        ...
        vscode_1.window.showTextDocument(doc, 1, false).then(undefined, function (error) {
            if (error.message) {
...
function showOfflinePrompt(addReconnectMsg) {
    if (addReconnectMsg === void 0) { addReconnectMsg = false; }
    return __awaiter(this, void 0, void 0, function () {
        var infoMsg;
        return __generator(this, function (_a) {
            ...
            vscode_1.window.showInformationMessage.apply(vscode_1.window, __spreadArrays([infoMsg], ["OK"]));
            return [2 /*return*/];
        });
    });
}
...
function randomCode() {
    return crypto
        .randomBytes(16)
        .map(function (value) { return exports.alpha.charCodeAt(Math.floor((value * exports.alpha.length) / 256)); })
        .toString();
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, wrapExecPromise("git config user.email", projectDir)];
                case 2:
                    email = _a.sent();
                    if (email) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    opts = projectDir !== undefined && projectDir !== null
                        ? { cwd: projectDir }
                        : {};
                    return [4 /*yield*/, execPromise(cmd, opts)["catch"](function (e) {
                            if (e.message) {
...
function launchLogin(loginType) {
    if (loginType === void 0) { loginType = "software"; }
    return __awaiter(this, void 0, void 0, function () {
...
function showLoginPrompt(serverIsOnline) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    infoMsg = "Finish creating your account and see rich data visualizations.";
                    return [4 /*yield*/, vscode_1.window.showInformationMessage.apply(vscode_1.window, __spreadArrays([infoMsg,
                            { modal: true }], [Constants_1.LOGIN_LABEL]))];
                case 1:
                    selection = _a.sent();
                    eventName = "";
                    eventType = "";
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    encodedJwt = encodeURIComponent(jwt);
                    connectAtlassianAuth = Constants_1.api_endpoint + "/auth/atlassian?token=" + jwt + "&plugin=" + getPluginType();
...
function getDashboardRow(label, value, isSectionHeader) {
    if (isSectionHeader === void 0) { isSectionHeader = false; }
...
function getTableHeader(leftLabel, rightLabel, isFullTable) {
    if (isFullTable === void 0) { isFullTable = true; }
...
function getDashboardLabel(label, width) {
    if (width === void 0) { width = exports.DASHBOARD_LABEL_WIDTH; }
