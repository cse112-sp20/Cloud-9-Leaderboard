    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            getRepoContributorInfo(fileName, filterOutNonEmails),
          ];
        case 1:
        ...
        case 2:
          ...
          if (resultList && resultList.length > 0) {
            ...
            resultList.forEach(function (listInfo) {
              ...
              var name = devInfo[0];
              var email = Util_1.normalizeGithubEmail(
                devInfo[1],
                filterOutNonEmails,
              );
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            Util_1.wrapExecPromise('git symbolic-ref --short HEAD', projectDir),
          ];
        case 1:
          branch = _a.sent();
          return [
            4 /*yield*/,
            Util_1.wrapExecPromise(
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            Util_1.wrapExecPromise('git config user.email', projectDir),
          ];
        case 3:
          email = _a.sent();
          return [
            4 /*yield*/,
            Util_1.wrapExecPromise('git describe --all', projectDir),
          ];
        case 4:
          tag = _a.sent();
...
function postRepoContributors(fileName) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, getRepoContributorInfo(fileName)];
        case 1:
          repoContributorInfo = _a.sent();
          if (repoContributorInfo) {
            // send this to the backend
            HttpClient_1.softwarePost(
              '/repo/contributors',
              repoContributorInfo,
              Util_1.getItem('jwt'),
            );
