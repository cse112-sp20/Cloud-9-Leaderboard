...
function getCommandResult(cmd, projectDir) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, Util_1.wrapExecPromise(cmd, projectDir)];
        case 1:
          result = _a.sent();
          if (!result) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            getCommitsInUtcRange(projectDir, start, end, useAuthor),
          ];
        case 1:
        ...
        case 1:
          ...
          authorOption =
            useAuthor && resourceInfo && resourceInfo.email
              ...
              : '';
          cmd =
            'git log --stat --pretty="COMMIT:%H,%ct,%cI,%s" --since=' +
            start +
            ' --until=' +
            end +
            authorOption;
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          if (repoUrlLink && repoUrlLink.endsWith('.git')) {
            repoUrlLink = repoUrlLink.substring(
              0,
              repoUrlLink.lastIndexOf('.git'),
            );
          }
          if (repoUrlLink) {
            // cache it
