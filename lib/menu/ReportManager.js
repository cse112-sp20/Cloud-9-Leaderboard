    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, DataController_1.writeProjectCommitDashboardByStartEnd(start, end, projectIds)];
                case 1:
                    // 1st write the code time metrics dashboard file
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // 1st write the code time metrics dashboard file
                return [4 /*yield*/, DataController_1.writeProjectCommitDashboardByRangeType(type, projectIds)];
                case 1:
                    // 1st write the code time metrics dashboard file
                    _a.sent();
                    openProjectCommitDocument();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // 1st write the code time metrics dashboard file
                return [4 /*yield*/, DataController_1.writeProjectContributorCommitDashboardFromGitLogs(identifier)];
                case 1:
                    // 1st write the code time metrics dashboard file
                    _a.sent();
...
function generateDailyReport(type, projectIds) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, DataController_1.writeDailyReportDashboard(type, projectIds)];
                case 1:
                    _a.sent();
                    filePath = Util_1.getDailyReportSummaryFile();
                    vscode_1.workspace.openTextDocument(filePath).then(function (doc) {
                        // only focus if it's not already open
                        vscode_1.window.showTextDocument(doc, vscode_1.ViewColumn.One, false).then(function (e) { return __awaiter(_this, void 0, void 0, function () {
                            var submitToSlack;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, vscode_1.window.showInformationMessage.apply(vscode_1.window, __spreadArrays(["Submit report to slack?"], ["Yes"]))];
                                    case 1:
