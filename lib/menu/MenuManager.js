...
function showMenuOptions() {
    return __awaiter(this, void 0, void 0, function () {
        var serverIsOnline, loggedIn, kpmMenuOptions, loginMsgDetail, toggleStatusBarTextLabel;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    loginMsgDetail = "Finish creating your account and see rich data visualizations.";
                    if (!serverIsOnline) {
                        loginMsgDetail =
...
function launchWebDashboardView() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, buildWebDashboardUrl()];
                case 1:
                    webUrl = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, DataController_1.writeCodeTimeMetricsDashboard()];
                case 1:
                    // 1st write the code time metrics dashboard file
                    _a.sent();
