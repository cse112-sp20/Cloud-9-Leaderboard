        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, vscode_1.window.showInformationMessage.apply(vscode_1.window, __spreadArrays(["Connect Slack to continue"], ["Yes"]))];
                case 1:
...
function disconnectSlack() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, vscode_1.window.showInformationMessage.apply(vscode_1.window, __spreadArrays(["Are you sure you would like to disconnect Slack?"], ["Yes"]))];
                case 1:
                    selection = _a.sent();
                    if (!(selection === "Yes")) return [3 /*break*/, 3];
                    return [4 /*yield*/, HttpClient_1.softwarePut("/auth/slack/disconnect", {}, Util_1.getItem("jwt"))];
                case 2:
                    result = _a.sent();
...
function slackContributor() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, showSlackChannelMenu()];
                case 1:
                    selectedChannel = _a.sent();
                    if (!selectedChannel) {
                        return [2 /*return*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    slackAccessToken = Util_1.getItem("slack_access_token");
                    web = new WebClient(slackAccessToken);
                    return [4 /*yield*/, web.channels
                            .list({ exclude_archived: true, exclude_members: false })["catch"](function (err) {
...
function getChannelNames() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getChannels()];
                case 1:
                    channels = _a.sent();
