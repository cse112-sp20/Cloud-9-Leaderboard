...
var ProjectCommitManager = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              vscode_1.window.showQuickPick(pickItems, {
          ...
          case 1:
            ...
            if (pick && pick.label) {
              return [
                2 /*return*/,
                this.launchProjectSelectionMenu(pick['value']),
              ];
            }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this.showDateInputBox(initialStartVal, dateFormat, 'starting'),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              this.showDateInputBox(endVal, dateFormat, 'ending'),
            ];
          case 3:
            endDateText = _a.sent();
            ...
            return [
              4 /*yield*/,
              this.getProjectCheckboxesByStartEnd(local_start, local_end),
            ];
          case 4:
            checkboxes = _a.sent();
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              this.getProjectCheckboxesByRangeType(selectedRangeType),
            ];
          case 7:
            checkboxes = _a.sent();
            return [2 /*return*/, this.launchProjectSelectionMenu(checkboxes)];
  ...
  ProjectCommitManager.prototype.launchProjectSelectionMenu = function (
    checkboxes,
  ) {
    return __awaiter(this, void 0, void 0, function () {
          ...
          case 1:
            ...
            if (picks && picks.length) {
              ...
              if (selectedRangeType) {
                ReportManager_1.displayProjectCommitsDashboardByRangeType(
                  selectedRangeType,
                  projectIds_1,
                );
              } else if (local_start && local_end) {
                ReportManager_1.displayProjectCommitsDashboardByStartEnd(
                  local_start,
                  local_end,
                  projectIds_1,
                );
  ...
  ProjectCommitManager.prototype.getProjectCheckboxesByStartEnd = function (
    start,
    end,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              this.getProjectCheckboxesByQueryString(qryStr),
            ];
          case 1:
  ...
  ProjectCommitManager.prototype.getProjectCheckboxesByRangeType = function (
    type,
  ) {
    if (type === void 0) {
      type = 'lastWeek';
  ...
  ProjectCommitManager.prototype.getProjectCheckboxesByQueryString = function (
    qryStr,
  ) {
    return __awaiter(this, void 0, void 0, function () {
      var api,
              ...
              if (projects && projects.length) {
                ...
                for (i = 0; i < projects.length; i++) {
                  ...
                  name_1 = p.project_name
                    ...
                    ? p.name
                    : '';
                  projectIds = p.projectIds ? p.projectIds : p.id ? [p.id] : [];
  ...
  ProjectCommitManager.prototype.showDateInputBox = function (
    value,
    placeHolder,
    datePrompt,
  ) {
            ...
            return [
              ...
              vscode_1.window.showInputBox({
                ...
                prompt:
                  'Please enter the ' +
                  datePrompt +
                  ' date of the custom time range (YYYY-MM-DD) to continue..',
