...
var codetimeCollapsedStateMap = {};
exports.connectCodeTimeMenuTreeView = function (view) {
  return vscode_1.Disposable.from(
    view.onDidCollapseElement(function (e) {
    ...
    view.onDidExpandElement(function (e) {
      return __awaiter(void 0, void 0, void 0, function () {
        var item;
        return __generator(this, function (_a) {
          item = e.element;
    ...
    view.onDidChangeSelection(function (e) {
      return __awaiter(void 0, void 0, void 0, function () {
        var item;
        return __generator(this, function (_a) {
...
var CodeTimeMenuProvider = /** @class */ (function () {
  function CodeTimeMenuProvider() {
    this._onDidChangeTreeData = new vscode_1.EventEmitter();
    this.onDidChangeTreeData = this._onDidChangeTreeData.event;
    this.initializedTree = false;
    //
  }
  CodeTimeMenuProvider.prototype.revealTree = function () {
    return __awaiter(this, void 0, void 0, function () {
      var item;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (!!this.initializedTree) return [3 /*break*/, 2];
            return [4 /*yield*/, this.refresh()];
          case 1:
            _a.sent();
            _a.label = 2;
          case 2:
            item = KpmProviderManager_1.KpmProviderManager.getInstance().getCodeTimeDashboardButton();
            try {
  ...
  CodeTimeMenuProvider.prototype.bindView = function (kpmTreeView) {
    this.view = kpmTreeView;
  };
  CodeTimeMenuProvider.prototype.getParent = function (_p) {
    return void 0; // all playlists are in root
  };
  CodeTimeMenuProvider.prototype.refresh = function () {
    this._onDidChangeTreeData.fire();
  };
  CodeTimeMenuProvider.prototype.refreshParent = function (parent) {
    this._onDidChangeTreeData.fire(parent);
  };
  CodeTimeMenuProvider.prototype.getTreeItem = function (p) {
    var treeItem = null;
    if (p.children.length) {
      var collasibleState = codetimeCollapsedStateMap[p.label];
      if (!collasibleState) {
  ...
  CodeTimeMenuProvider.prototype.getChildren = function (element) {
    return __awaiter(this, void 0, void 0, function () {
      var kpmItems;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [3 /*break*/, 3];
          case 1:
            return [4 /*yield*/, kpmProviderMgr.getOptionsTreeParents()];
          case 2:
            // return the parent elements
            kpmItems = _a.sent();
            _a.label = 3;
          case 3:
            return [2 /*return*/, kpmItems];
        }
      });
    });
  };
  return CodeTimeMenuProvider;
})();
