...
var KpmProviderManager = /** @class */ (function () {
  ...
  KpmProviderManager.prototype.setCurrentKeystrokeStats = function (
    keystrokeStats,
  ) {
    var _this = this;
    if (keystrokeStats) {
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!loggedIn) {
              ...
              googleSignupButton = this.getActionButton(
                signupWithGoogle,
                '',
              ...
              githubSignupButton = this.getActionButton(
                signupWithGithub,
                '',
              ...
              softwareSignupButton = this.getActionButton(
                signupWithEmail,
                '',
              ...
              dividerButton = this.getActionButton(
                '',
                '',
                '',
                'blue-line-96.png',
              ...
              if (connectedToInfo) {
                connectedToButton = this.getActionButton(
            ...
            toggleStatusBarButton = this.getActionButton(
              toggleStatusBarTextLabel,
            ...
            readmeButton = this.getActionButton(
              learnMoreLabel,
            ...
            feedbackButton = this.getActionButton(
              'Submit feedback',
            ...
            reportDividerButton = this.getActionButton(
              '',
              '',
              '',
              'blue-line-96.png',
            ...
            generateProjectSummaryButton = this.getActionButton(
              commitSummitLabel,
              '',
  ...
  KpmProviderManager.prototype.getKpmTreeParents = function () {
    return __awaiter(this, void 0, void 0, function () {
      var treeItems,
        sessionSummaryData,
        currentKeystrokesItems,
        fileChangeInfoMap,
        filesChanged,
        fileChangeInfos,
        highKpmParent,
        mostEditedFileItem,
        longestCodeTimeParent;
      return __generator(this, function (_a) {
        treeItems = [];
        sessionSummaryData = SessionSummaryData_1.getSessionSummaryData();
        currentKeystrokesItems = this.getSessionSummaryItems(
          sessionSummaryData,
        );
        ...
        if (filesChanged > 0) {
          ...
          if (filesChanged) {
            fileChangeInfos = Object.keys(fileChangeInfoMap).map(function (
              key,
            ) {
            ...
            longestCodeTimeParent = this.buildLongestFileCodeTime(
              fileChangeInfos,
            );
  ...
  KpmProviderManager.prototype.getCommitTreeParents = function () {
    return __awaiter(this, void 0, void 0, function () {
      var folders,
        ...
        workspaceFolder,
        projectDir,
        currentChagesSummary,
        name_1,
        openChangesMetrics,
        openChangesFolder,
        todaysChagesSummary,
        committedChangesMetrics,
        committedChangesFolder,
        openChangesParent,
        committedChangesParent;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
          ...
          case 2:
            ...
            openChangesFolder = this.buildParentItem(
              name_1,
              '',
              openChangesMetrics,
            );
          ...
          case 3:
            ...
            committedChangesFolder = this.buildParentItem(
              name_1,
              '',
              committedChangesMetrics,
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              KpmRepoManager_1.getRepoContributors(activeRootPath, false),
            ];
          case 1:
            teamMembers = _a.sent();
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              GitUtil_1.getLastCommitId(activeRootPath, member.email),
            ];
          case 4:
  ...
  KpmProviderManager.prototype.getActionButton = function (
    label,
    tooltip,
    command,
    icon,
  ...
  KpmProviderManager.prototype.getSessionSummaryItems = function (data) {
    ...
    var wallClktimeStr = Util_1.humanizeMinutes(
    ...
    values = [];
    var dayMinutesStr = Util_1.humanizeMinutes(
    ...
    var globalMinutesStr = Util_1.humanizeMinutes(
    ...
    var globalLinesRemoved = numeral(data.globalAverageLinesRemoved).format(
      '0 a',
    );
    values.push({
    ...
    var globalKeystrokes = numeral(data.globalAverageDailyKeystrokes).format(
      '0 a',
    );
    values.push({
  ...
  KpmProviderManager.prototype.buildMetricItem = function (
    label,
    value,
    tooltip,
    icon,
  ...
  KpmProviderManager.prototype.buildTreeMetricItem = function (
    label,
    tooltip,
    value,
    icon,
  ...
  KpmProviderManager.prototype.buildActivityComparisonNodes = function (
    label,
    tooltip,
    values,
    collapsibleState,
  ...
  KpmProviderManager.prototype.buildMessageItem = function (
    label,
    tooltip,
    icon,
    command,
  ...
  KpmProviderManager.prototype.buildParentItem = function (
    label,
    tooltip,
    children,
  ) {
  ...
  KpmProviderManager.prototype.buildMostEditedFileItem = function (
    fileChangeInfos,
  ) {
    ...
    var sortedArray = fileChangeInfos.sort(function (a, b) {
      return b.keystrokes - a.keystrokes;
    });
    ...
    for (var i = 0; i < len; i++) {
      ...
      var messageItem = this.buildMessageItem(
        label,
        '',
        null,
    ...
    var mostEditedParent = this.buildParentItem(
  ...
  KpmProviderManager.prototype.buildHighestKpmFileItem = function (
    fileChangeInfos,
  ) {
    if (!fileChangeInfos || fileChangeInfos.length === 0) {
      return null;
    ...
    var highKpmParent = this.buildParentItem(
      'Top files by KPM',
  ...
  KpmProviderManager.prototype.buildLongestFileCodeTime = function (
    fileChangeInfos,
  ) {
    if (!fileChangeInfos || fileChangeInfos.length === 0) {
      return null;
    ...
    var longestCodeTimeParent = this.buildParentItem(
...
var KpmTreeItem = /** @class */ (function (_super) {
  ...
  function KpmTreeItem(treeItem, collapsibleState, command) {
    ...
    var _a = getTreeItemIcon(treeItem),
      lightPath = _a.lightPath,
      darkPath = _a.darkPath;
...
exports.handleKpmChangeSelection = function (view, item) {
  if (item.command) {
    ...
    if (args) {
      vscode_1.commands.executeCommand.apply(
        vscode_1.commands,
        __spreadArrays([item.command], args),
      );
    } else {
      // run the command
