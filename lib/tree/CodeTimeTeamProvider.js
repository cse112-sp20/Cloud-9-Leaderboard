...
var teamCollapsedStateMap = {};
exports.connectCodeTimeTeamTreeView = function (view) {
...
var CodeTimeTeamProvider = /** @class */ (function () {
  function CodeTimeTeamProvider() {
    this._onDidChangeTreeData = new vscode_1.EventEmitter();
    this.onDidChangeTreeData = this._onDidChangeTreeData.event;
    //
  }
  CodeTimeTeamProvider.prototype.bindView = function (kpmTreeView) {
    this.view = kpmTreeView;
  };
  CodeTimeTeamProvider.prototype.getParent = function (_p) {
    return void 0; // all playlists are in root
  };
  CodeTimeTeamProvider.prototype.refresh = function () {
    this._onDidChangeTreeData.fire();
  };
  CodeTimeTeamProvider.prototype.refreshParent = function (parent) {
    this._onDidChangeTreeData.fire(parent);
  };
  CodeTimeTeamProvider.prototype.getTreeItem = function (p) {
    var treeItem = null;
    if (p.children.length) {
      var collasibleState = teamCollapsedStateMap[p.label];
      if (!collasibleState) {
  ...
  CodeTimeTeamProvider.prototype.getChildren = function (element) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [3 /*break*/, 3];
          case 1:
            return [4 /*yield*/, kpmProviderMgr.getTeamTreeParents()];
          case 2:
