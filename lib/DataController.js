    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            HttpClient_1.softwareGet(api, Util_1.getItem('jwt')),
          ];
        case 1:
          resp = _a.sent();
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            HttpClient_1.softwarePost(api, payload, Util_1.getItem('jwt')),
          ];
        case 1:
          resp = _a.sent();
          if (HttpClient_1.isResponseOk(resp)) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            HttpClient_1.softwareGet(
              '/data/apptoken?token=' + Util_1.nowInSecs(),
              null,
            ),
          ];
        case 1:
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          api = '/users/' + userId;
          showGitMetrics = vscode_1.workspace
            .getConfiguration()
            .get('showGitMetrics');
          ...
          return [
            4 /*yield*/,
            HttpClient_1.softwarePut(api, userPrefs, Util_1.getItem('jwt')),
          ];
        case 1:
          resp = _a.sent();
          if (HttpClient_1.isResponseOk(resp)) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          if (
            !(resp && resp.data && resp.data.data && resp.data.data.preferences)
          )
            return [3 /*break*/, 5];
          ...
          return [
            4 /*yield*/,
            sendPreferencesUpdate(parseInt(user.id, 10), prefs),
          ];
        case 4:
          _a.sent();
          _a.label = 5;
...
function refetchUserStatusLazily(tryCountUntilFoundUser, interval) {
  if (tryCountUntilFoundUser === void 0) {
      ...
      switch (_b.label) {
        ...
        case 1:
          heartbeat =
            ...
            _a);
          api = '/data/heartbeat';
          HttpClient_1.softwarePost(api, heartbeat, jwt).then(function (resp) {
        ...
        case 2:
          ...
          if (HttpClient_1.isResponseOk(result) && result.data) {
            ...
            fs.writeFileSync(filePath, content, function (err) {
              if (err) {
                Util_1.logIt(
                  'Error writing to the weekly commit summary content file: ' +
                    err.message,
                );
              }
            });
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          result = _b.sent();
          (_a = createStartEndRangeByTimestamps(start, end)),
            (rangeStart = _a.rangeStart),
            (rangeEnd = _a.rangeEnd);
          return [
            4 /*yield*/,
            writeProjectCommitDashboard(result, rangeStart, rangeEnd),
          ];
        case 2:
          _b.sent();
          return [2 /*return*/];
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          result = _b.sent();
          (_a = createStartEndRangeByType(type)),
            (rangeStart = _a.rangeStart),
            (rangeEnd = _a.rangeEnd);
          return [
            4 /*yield*/,
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      if (HttpClient_1.isResponseOk(apiResult)) {
        ...
        dashboardContent =
          'CODE TIME PROJECT SUMMARY     (Last updated on ' +
          formattedDate +
          ')';
        dashboardContent += '\n\n';
        if (codeCommitData && codeCommitData.length) {
          // filter out null project names
          codeCommitData = codeCommitData.filter(function (n) {
            return n.name;
          });
          codeCommitData.forEach(function (el) {
            dashboardContent += Util_1.getDashboardRow(
              el.name,
...
function writeProjectContributorCommitDashboardFromGitLogs(identifier) {
  return __awaiter(this, void 0, void 0, function () {
    var activeRootPath,
      userTodaysChangeStatsP,
      userYesterdaysChangeStatsP,
      userWeeksChangeStatsP,
      contributorsTodaysChangeStatsP,
      contributorsYesterdaysChangeStatsP,
      contributorsWeeksChangeStatsP,
      dashboardContent,
      now,
      formattedDate,
      projectDate,
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          ...
          userYesterdaysChangeStatsP = GitUtil_1.getYesterdaysCommits(
            activeRootPath,
          );
          userWeeksChangeStatsP = GitUtil_1.getThisWeeksCommits(activeRootPath);
          contributorsTodaysChangeStatsP = GitUtil_1.getTodaysCommits(
            activeRootPath,
            false,
          );
          contributorsYesterdaysChangeStatsP = GitUtil_1.getYesterdaysCommits(
            activeRootPath,
            false,
          );
          contributorsWeeksChangeStatsP = GitUtil_1.getThisWeeksCommits(
            activeRootPath,
            false,
          );
          dashboardContent = '';
          ...
          dashboardContent = Util_1.getTableHeader(
            'PROJECT SUMMARY',
          ...
          dashboardContent += Util_1.getRightAlignedTableHeader(
            'Today (' + projectDate + ')',
          );
        ...
        case 2:
          summary = ((_a.contributorActivity = _d.sent()), _a);
        ...
        case 4:
          summary = ((_b.contributorActivity = _d.sent()), _b);
          dashboardContent += getRowNumberData(
            summary,
            'Commits',
            'commitCount',
        ...
        case 6:
          summary = ((_c.contributorActivity = _d.sent()), _c);
          dashboardContent += getRowNumberData(
            summary,
            'Commits',
            'commitCount',
            ...
            for (i = 0; i < data.length; i++) {
              ...
              if (i === 0) {
                ...
                startDate = moment
                  ...
                  .format('MMM Do, YYYY');
                projectDate =
                  'This month (' + startDate + ' to ' + projectDate + ')';
              }
              dashboardContent += Util_1.getRightAlignedTableHeader(
                projectDate,
              );
      ...
      switch (_a.label) {
        ...
        case 1:
          ...
          showGitMetrics = vscode_1.workspace
            ...
            .get('showGitMetrics');
          api =
            '/dashboard?showMusic=false&showGit=' +
            showGitMetrics +
            '&showRank=false&linux=' +
            Util_1.isLinux() +
            '&showToday=false';
          return [
            4 /*yield*/,
