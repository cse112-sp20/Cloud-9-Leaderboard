    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (vscode_1.window.state.focused) {
                ...
                setTimeout(function () {
                    EventManager_1.EventManager.getInstance().createCodeTimeEvent(nonFocusedEventType_1, eventName, 'onboarding');
                    OnboardManager_1.onboardInit(ctx, intializePlugin /*successFunction*/);
                }, 1000 * secondDelay);
            }
            // sign the user in
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, DataController_1.initializePreferences(serverIsOnline)];
                case 2:
                    // get the user preferences whether it's music time or code time
                    // this will also fetch the user and update loggedInCacheState if it's found
                    _a.sent();
...
function initializeIntervalJobs() {
    var _this = this;
    hourly_interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
        var isonline;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    thirty_minute_interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
        var isonline;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, HttpClient_1.serverIsAvailable()];
                case 1:
                    isonline = _a.sent();
                    return [4 /*yield*/, KpmRepoManager_1.getHistoricalCommits(isonline)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    twenty_minute_interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
        var name_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, FileManager_1.sendOfflineEvents()];
                case 1:
                    _a.sent();
    ...
    fifteen_minute_interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            vscode_1.commands.executeCommand('codetime.sendOfflineData');
            return [2 /*return*/];
        });
    ...
    liveshare_update_interval = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (vscode_1.window.state.focused) {
                updateLiveshareTime();
            }
...
function initializeLiveshare() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, vsls.getApi()];
                case 1:
                    liveshare = _a.sent();
                    if (liveshare) {
                        // {access: number, id: string, peerNumber: number, role: number, user: json}
                        Util_1.logIt("liveshare version - " + liveshare['apiVersion']);
                        liveshare.onDidChangeSession(function (event) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        _ls['end'] = 0;
                                        return [4 /*yield*/, LiveshareManager_1.manageLiveshareSession(_ls)];
                                    case 1:
                                        _a.sent();
                                        return [3 /*break*/, 4];
                                    case 2:
                                        if (!(_ls && (!event || !event['id']))) return [3 /*break*/, 4];
                                        updateLiveshareTime();
                                        // close the session on our end
                                        _ls['end'] = nowSec;
                                        _ls['local_end'] = localNow;
