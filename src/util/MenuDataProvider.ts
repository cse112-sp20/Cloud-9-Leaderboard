import {
  ...
  export class MenuDataProvider implements TreeDataProvider<MenuItem> {
    ...
    private _onDidChangeTreeData: EventEmitter<MenuItem | undefined> = new EventEmitter<MenuItem | undefined>();
    readonly onDidChangeTreeData: Event<MenuItem | undefined> = this._onDidChangeTreeData.event;
